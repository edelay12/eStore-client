  ...
  renderLogoutLink() {
    return (
      <div className="Header__logged-inMenu">
        <Link onClick={this.props.close} to="/">
          <span className="logoutLinkMenu">Logout</span>
        </Link>
      </div>
    );
  }
  ...
  renderLoginLink() {
    return (
      <div className="Header__not-logged-inMenu">
        <Link to="/register">
          <Button onClick={this.props.close}>Register</Button>
        </Link>
        <Link to="/login">
          <span className="loginLinkMenu" onClick={this.props.close}>
            Log in
          </span>
        </Link>
      </div>
