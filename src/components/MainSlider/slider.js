    ...
    <div className='container'>
      ...
      <div id='slideContainer'>
           <div id='Background'>
               ...
               <span id='heroSubBanner'>Be sure to visit the admin page to edit the products</span>
               <Link to={'/shop/collections'}><Button id='mainShopButton' type='button'>Shop Now</Button></Link>
               </div>
          ...
          <div id='slideContainer'>
           <div id='Background'>
               ...
               <span id='heroSubBanner'>Be sure to visit the admin page to edit the products</span>
               <Link to={'/shop/collections/sale'}><Button id='mainShopButton' type='button'>Shop Now</Button></Link>
               </div>
           </div>
          </div>
